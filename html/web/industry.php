		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
                ...
                <?php getMessage();?>
					...
					switch($q) {
						case "add" : {include_once("includes/industry_add.php"); break;}
						case "edit" : {include_once("includes/industry_edit.php"); break;}
						default:  {include_once("includes/industry_list.php"); break;}
					}?>

		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
                ...
                <?php getMessage();?>
					...
					switch($q) {
						case "add" : {include_once("includes/coupon_add.php"); break;}
						case "edit" : {include_once("includes/coupon_edit.php"); break;}
                    
						default:  { include_once("includes/coupon_list.php"); break;}
					}?>

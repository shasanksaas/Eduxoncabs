		...
		<div class="content-top">
			...
			<div class="col-md-12 ">
                ...
                <?php getMessage();?>
					...
					switch($q) {
						case "add" : {include_once("includes/location_add.php"); break;}
						case "edit" : {include_once("includes/location_edit.php"); break;}
                                                case "addcity" : {include_once("includes/city_add.php"); break;}
                                                case "editcity" : {include_once("includes/city_edit.php"); break;}
						default:  { include_once("includes/location_list.php"); break;}
					}?>

<?php
	...
	$get_cnt_dates = $dbObj->countRec("tbl_unavail_dtes","car_id = $id");

	$get_dates = $dbObj->fetch_data("tbl_unavail_dtes","car_id = $id");
						...
						<div class="form-group">
                                                           ...
                                                           <div class="form-group">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    ...
                                                                    <input type="text" class="form-control1" id="car_ofr" name="car_ofr" value="<?php echo $get_loc[0]['offers'];?>" >
                                                           ...
                                                           <tr>
                                                             ...
                                                             <p>
                                                               ...
                                                               <td><input type="checkbox" name="chk[]" /></td>
                                                                ...
                                                                <td>Unavailable Date from <br /><input type="date" class="" min="<?php echo date("Y-m-d"); ?>" name="unavail_datefrm[]" value="<?php echo date('Y-m-d',strtotime($get_dates[$z]['unavail_dte']));?>"><?php //echo date('H:i',strtotime($get_dates[$z]['unavail_dte_t));//echo date("H:i",strtotime("$get_dates[$z]['unavail_dte_to']"));?></td>

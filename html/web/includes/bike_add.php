			...
			<div class="col-md-12 top-content">
                <div class="grid-form1">
  	       			<div class="bs-example" data-example-id="form-validation-states-with-icons">
                             ...
                             <input type="hidden" name="act" value="addbike" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control1" id="bike_nme" name="bike_nme" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <input type="file" class="form-control1" id="bike_image" name="bike_image" required/>
                                                    </div>
						...
						<div class="form-group">
								...
								<input type="text" class="form-control1" id="weekendcost"  onkeypress="return isNumber(event)" maxlength="5" name="weekendcost" required>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control1" id="bike_ofr" name="bike_ofr" > 
                                                    </div>

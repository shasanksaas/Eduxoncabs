			...
			<div class="col-md-12 top-content">
                <div class="grid-form1">
  	       			<div class="bs-example" data-example-id="form-validation-states-with-icons">
                             ...
                             <input type="hidden" name="act" value="addcoupon" />
                             
                                                
                                                <div class="form-group">
                                                    <label for="focusedinput" class="col-sm-2 control-label">Coupon </label>
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control1" id="coupon" name="coupon" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" class="form-control1" id="couponpercent" name="couponpercent" required>
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" class="" min="<?php echo date("Y-m-d"); ?>" name="fromdate" />
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" class="" min="<?php echo date("Y-m-d"); ?>" name="todate" />
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" class="" min="<?php echo date("Y-m-d"); ?>" name="issuedate" />
                                               ...
                                               <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="date" class="" min="<?php echo date("Y-m-d"); ?>" name="expdate" />

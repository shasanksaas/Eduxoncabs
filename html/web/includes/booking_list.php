...
function deleteMessage(u_id){
	...
	<div class="col-md-12 ">
               ...
               <?php
                          ...
                          $qr = "AND pickup_point='$location'";
                     ?>
                     <div>
                     <?php if($admin_type==1){?>
                       <a  href='book.php?q=Bhubaneswar&location=1'><span style="<?=$bbsr_clr;?>"> Bhubaneswar Airport</span></a>
                           &nbsp;&nbsp;&nbsp;&nbsp;
                          <a style="margin-right: 150px;" href='book.php?q=Patia&location=3'> <span style="<?=$paita_clr ;?>"> Patia</span></a>
                          
                          <a style="margin-right: 150px;" href='book.php?q=Cuttack&location=2 '> <span style="<?=$ctk_clr;?>"> Cuttack </span></a>
                    ...
                    <table class="table-bordered table-striped table-condensed cf">
                        ...
                        <?php	
							$i = 1;		
							$getdta = $dbObj->fetch_data("tbl_order","status='Completed'AND vehicle_type='1' $qr","id DESC limit 0,500");
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                      <table border="1">
                                        ...
                                        <tr><td>Booked Car</td><td><?php echo $key['booked_car'];?></td></tr>
...
$getdta = $dbObj->fetch_data("tbl_customer","phone_number='".$key['phone']."'","");
							foreach($getdta as $key){ 
                                            ...
                                            <tr><td>License Number </td><td><?php echo $key['license_number']; ?></td></tr>
                                                      <?php } else{?>

                                        <tr><td colspan='2' align='center'><a href="../<?php echo $key['license'];?>" target="_blank">Click to view licence</a></td></tr>
<?php  } } ?>
                                      </table>
                                    </div>

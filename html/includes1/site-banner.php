              ...
              <div class="container">
                <div class="row clearfix">
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="r-logo">
                      <a href="#" class="d-inline-block"><img src="assets/images/footer-logo.png" class="img-fluid d-block" alt="footer-logo"></a>
                    </div>
                    <a href="javaScript:void(0)" class="menu-icon"> <i class="fa fa-bars"></i> </a>
                  </div>
                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-xs-12 pr-0">
                    <div class="r-header-action float-right">
                      <a href="login-register.html"> <i class="fa fa-lock"></i> <span>Login</span></a>
                      <a href="#" class="r-search"> <i class="fa fa-search"></i>  <span>Search</span></a>
            ...
            <div class="r-slider r-slider-02">  
              <div class="r-slider owl-carousel" id="defaultHomeSlider">
                <div class="r-slider-item">
                  <img src="assets/images/main-slider-01.jpg" class="img-fluid d-block m-auto" alt="main-slider-01">
                  <div class="container">
                ...
                <div class="r-slider-item">
                  <img src="assets/images/main-slider-04.jpg" class="img-fluid d-block m-auto" alt="main-slider-04">
                  <div class="container">
                    <div class="r-slider-top-content">
                ...
                <div class="r-slider-item">
                  <img src="assets/images/main-slider-05.jpg" class="img-fluid d-block m-auto" alt="main-slider-05">
                  <div class="container">
                    <div class="r-slider-top-content">

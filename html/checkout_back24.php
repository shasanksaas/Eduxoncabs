    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          ...
          <form action="pay.php" method="POST" style="margin-top:20px;" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <input type="number" value="" data-msg-required="Please enter mobile number." maxlength="10" class="form-control" name="phone" autocomplete="off" id="phone" required>
                </div>

                <div class="col-md-6">
                  <label>DOB (licence) *</label>
                  <input type="text" value="" data-msg-required="Please enter DOB."  class="form-control" name="dob" autocomplete="off"  id="dob" placeholder="YYYY-MM-DD" required>
                </div>

                <div class="col-md-4">
                  <label><span id='cpnmsg' style="font-size:9px;"></span></label>
                  <input type="text" data-msg-required="Invalid Coupon."  class="form-control" name="coupon" autocomplete="off"  id="coupon"   placeholder="coupon" /> <input type="button" name='checkgv' id='checkgv' value="Apply Coupon Code"   style="background:#006600; color:#fff; border-radius:5px;font-size:17px; margin-top:10px; padding:5px 8px;">
                </div>

               <!--<div class="col-md-4" style="margin-top:15px;">
                  <label>Upload DL Copy *<span id='cpnmsg' style="font-size:9px;">jpeg,jpg,png</span></label>
                  <input type="file" class="form-control" name="license"  id="license" required /> 
                </div>-->
                <div class="col-md-6" style="margin-top:15px;">
                  <label>DL Number *</label>
                  <input type="text" class="form-control" name="licenseNumber" autocomplete="off"  id="licenseNumber" maxlength="18" required /> 
                </div>
            ...
            <div class="row" style="margin-top:20px;">
              ...
              <div class="col-md-6">
                ...
                <input type="submit" id='book_now' name='reserve' value="Reserve Now" class="btn btn-primary btn-lg mb-xlg" >
              </div>
            </div>
          </form>
        </div>

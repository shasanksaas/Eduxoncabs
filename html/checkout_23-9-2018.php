...
$get_id = filter($_GET['cardta']);

$get_car_dta = $dbObj->fetch_data("tbl_cabs", "md5(id) = '$get_id'");


$pdate = filter($_GET['pdate']);

$ptime = filter($_GET['ptime']);

$ddate = filter($_GET['ddate']);

$dtime = filter($_GET['dtime']);
  ...
  <div role="main" class="main">
    <div class="container">
      <div class="row">
          ...
          <form action="pay.php" method="POST" style="margin-top:20px;">
              ...
              <div class="form-group">
                <div class="col-md-8">
                  ...
                  <?php
                                                ...
                                                ?>
                  <input type="text" value="<?=$get_city_dta[0]['city_location'];?>" disabled class="form-control" name="city" id="city" autocomplete="off" required>
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-md-6">
                  ...
                  <input type="text" maxlength="100" class="form-control" name="pdate" value="<?php echo $pdate; ?>" id="pdate" autocomplete="off" required onChange="return calculateTime($('#dtime').val(), this.value, $('#ptime').val(), $('#ddate').val());">
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-md-6">
                  ...
                  <input type="text" value="<?php echo $ddate; ?>" maxlength="100" class="form-control" name="ddate" autocomplete="off" id="ddate" required onBlur="return calculateTime($('#dtime').val(), $('#pdate').val(), $('#ptime').val(), this.value);" placeholder="YYYY-MM-DD">
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
              <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" value="" data-msg-required="Please enter the subject."  class="form-control" name="dob" autocomplete="off"  id="dob" required  placeholder="YYYY-MM-DD" required>
                </div>
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-md-12">
                  ...
                  I have Read & Accepted all <a href="https://www.eduxoncabs.com/page.php?page=faq" style="color:red;" target="blank">Terms & Conditions</a> and Payments etc*</label>
                </div>
              </div>
            </div>
            <div class="row" style="margin-top:20px;">
              ...
              <div class="col-md-6">
                ...
                <input type="hidden" name='securitymoneyprice' value="<?php echo $get_car_dta[0]['security']; ?>" />
        ...
        <div class="col-md-4">
          <div class="col-md-12"> <img src="uploadedDocument/cab/<?php echo $get_car_dta[0]['car_image']; ?>" class="img-responsive" alt="car_image"> </div>
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <h6 class="mb-sm mt-sm" style="color:#000;text-align:justify;"><strong>Price Regular Days Rs. <span id="price"><?php echo $get_car_dta[0]['cost']; ?></span> / 24 Hr</strong></h4>
          </div>
          <div class="col-md-12">
            <h6 class="mb-sm mt-sm" style="color:#000;text-align:justify;"><strong>Weekend Price:Rs. <span id="price"><?php echo $get_car_dta[0]['weekend_cost']; ?></span> / 24 Hr</strong></h4>
          </div>
          ...
          <div class="col-md-12">
            <h6 class="mb-sm mt-sm" style="color:#000;text-align:justify;"><strong> Refundable Security Fees:Rs. <span id="price"><?php echo $get_car_dta[0]['security']; ?></span> / -</strong></h6>
          </div>

<!-- <div class="col-md-12" id="discount"> </div> -->

         <div class="col-md-12"><hr style="display: block; margin-top: 0.5em; margin-bottom: 0.5em; margin-left: auto; margin-right: auto;    border-style: inset;  border-width: 1px;"></div>
...
<script>
                ...
                $(document).ready(function () {
                    ...
                    if(totalAmt > 3500){
$('#discount').html('<input type="text" name="coupon" id="coupon" placeholder="coupon code" />');
}else{
$('#discount').html('');
}
                    ...
                    $('#finalPrice').html('<h4 class="mb-sm mt-sm" style="color:#FF0000"><strong> Total Cost Rs. <span id="price">' + Math.round(totalAmt +<?php echo $get_car_dta[0]['security']; ?>) + '</span> / -</strong></h4>');



                    $("#security-payment-type").change(function () {
                        /*var picdate = $('#pdate').val();
                         var pictime = $('#ptime').val();
                         var dropdate = $('#ddate').val();
                         var droptime = $('#dtime').val();
                         */
                        ...
                        if (securityPaymentType == "cash") {
                            //$('#totalAmt').val(amount);
                            $('#finalPrice').html('<h4 class="mb-sm mt-sm" style="color:#FF0000"><strong> Total Cost Rs. <span id="price">' + Math.round(totalpayable -<?php echo $get_car_dta[0]['security']; ?>) + '</span> / -</strong></h4>');
                            //$('#totalAmt').val(totalpayable-<?php echo $get_car_dta[0]['security']; ?>);
                        }
                ...
                function calculateTime(dropTime, pdate, ptime, ddate) {
                    ...
                    if (dropTime != 0) {
                        ...
                        if(tot>3500){  $('#discount').html('<input type="text" name="coupon" id="coupon" placeholder="coupon code" />'); }else{ $('#discount').html('');}

                        $('#totalAmt').val(Math.round(tot +<?php echo $get_car_dta[0]['security']; ?>));

                        $('#finalPrice').html('<h4 class="mb-sm mt-sm" style="color:#FF0000"><strong> Total Cost Rs. <span id="price">' + Math.round(tot +<?php echo $get_car_dta[0]['security']; ?>) + '</span> / -</strong></h4>');

                        $('#security-payment-type').val('online');

                        //alert(( new Date("1970-12-5 12:42") - new Date("1970-11-3 9:42") ) / 1000 / 60 / 60 );



                        //alert(( new Date(dropTime) - new Date(pickTime) ) / 1000 / 60 / 60 );

                        //var duration = moment.duration(end.diff(dropTime));
                ...
                function calc_price(frmDate, toDate) {
                    ...
                    /*
                     ...
                     if ("'"+start_date_only +"'" != "'"+end_date_only+"'" && total_day_hour<24){
                     no_of_loop+=1;
                     }
                     if ("'"+start_date_only +"'" != "'"+end_date_only+"'" && total_day_hour<24){
                     no_of_loop+=1;

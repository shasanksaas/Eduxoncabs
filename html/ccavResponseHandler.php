...
print_r($decryptValues); exit;
			...
			if($order_status==="Success")
			{
				...
				$dbObj->insertToDb("tbl_unavail_dtes","type = '1', car_id = '$car_id', bike_id = '0', unavail_dte = '$booked_dte $booked_tme', unavail_dte_to = '$returned_dte $returned_tme', status = '0', payment_id = '$payment_id'");
				?>

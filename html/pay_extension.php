...
$csrf_token = mysql_real_escape_string($mysqli_conn,$_POST["csrf"]);
$product_name = mysql_real_escape_string($mysqli_conn,$_POST["carnme"]);
$form_price = mysql_real_escape_string($mysqli_conn,$_POST["totalAmt"]); // comming with security price
$name = mysql_real_escape_string($mysqli_conn,$_POST["name"]);
$phone = mysql_real_escape_string($mysqli_conn,$_POST["phone"]);
$email = mysql_real_escape_string($mysqli_conn,$_POST["email"]);
$city = mysql_real_escape_string($mysqli_conn,$_POST['city1']);
$car_id = mysql_real_escape_string($mysqli_conn,$_POST['car_id']);
$pickuploc = mysql_real_escape_string($mysqli_conn,$_POST['pickuploc']);
$dob = mysql_real_escape_string($mysqli_conn,$_POST['dob']);
$coupon_status = mysql_real_escape_string($mysqli_conn,$_POST['gvcode']);
$coupon_code = mysql_real_escape_string($mysqli_conn,$_POST['coupon']);
$gvamount = isset($_POST['gvamount']) && $_POST['gvamount'] !== '' ? (int)mysql_real_escape_string($mysqli_conn,$_POST['gvamount']) : 0;
$licenseNumber= mysql_real_escape_string($mysqli_conn,$_POST['licenseNumber']);
...
$wkdayshr = isset($_POST['wkdayshr']) && $_POST['wkdayshr'] !== '' ? (int)mysql_real_escape_string($mysqli_conn,$_POST['wkdayshr']) : 0;
$wkendhr = isset($_POST['wkendhr']) && $_POST['wkendhr'] !== '' ? (int)mysql_real_escape_string($mysqli_conn,$_POST['wkendhr']) : 0;
$wkdaysamnt = isset($_POST['wkdaysamnt']) && $_POST['wkdaysamnt'] !== '' ? (float)mysql_real_escape_string($mysqli_conn,$_POST['wkdaysamnt']) : 0;
$wkendamnt = isset($_POST['wkendamnt']) && $_POST['wkendamnt'] !== '' ? (float)mysql_real_escape_string($mysqli_conn,$_POST['wkendamnt']) : 0;

$_SESSION['trvlDte'] = mysql_real_escape_string($mysqli_conn,$_POST['pdate']);
$_SESSION['trvltme'] = mysql_real_escape_string($mysqli_conn,$_POST['ptime']);
$_SESSION['retnDte'] = mysql_real_escape_string($mysqli_conn,$_POST['ddate']);
$_SESSION['retntme'] = mysql_real_escape_string($mysqli_conn,$_POST['dtime']);
$_SESSION['vehicle_id'] = mysql_real_escape_string($mysqli_conn,$_POST['car_id']);
$booked_dte = mysql_real_escape_string($mysqli_conn,$_POST['pdate']);
$booked_tme = mysql_real_escape_string($mysqli_conn,$_POST['ptime']);

$returned_dte = mysql_real_escape_string($mysqli_conn,$_POST['ddate']);
$returned_tme = mysql_real_escape_string($mysqli_conn,$_POST['dtime']);

$securityPayment = mysql_real_escape_string($mysqli_conn,$_POST['securityPayment']);
$securityprice = mysql_real_escape_string($mysqli_conn,$_POST['securitymoneyprice']);
...
?>
    <script>
        ...
        window.location = "allcars-car-for-self-drive.php?ermsg=1";
    </script>
<?php
return;
}else{
...
function calc_price($start_book_time, $end_book_time , $vehicle_cost , $vehicle_weekend_cost){
        ...
        for ($i = 0; $i < $no_of_loop; $i++) {
            ...
            if ( $cur_date == $end_date) {
                ...
                $totalhrperday = (strtotime($end_dt_tm) - strtotime($strt_dt_tm) )/3600; 
            ...
            //echo " : ".$total_price ." - $totalhrperday : $perhour <br>";exit;
